...
\centerline{Table 1: EPA Air Quality}
|Item Name|Value|
|----:|:------|
...
```{r, warning = FALSE, message = FALSE, echo = FALSE, fig.width = 7, fig.height = 3, fig.cap = "2018 monthly Ozone levels"}
...
OZ18_boxplot <- Data_2018 %>% 
  ggplot(aes(x = factor(Month, levels = 1:12, labels = month.abb), y = Ozone)) +
  geom_boxplot() +
  ylab("Concentration (\U003BCg/m\U00B3)") +
  # the earlier notation for mu didn't work here
  xlab("Month") +
...
```{r, warning = FALSE, message = FALSE, echo = FALSE, fig.width = 7, fig.height = 3, fig.cap = "2019 monthly Ozone levels"}
...
```{r}
#ask about greek letters
#ask about figure spacing
```
